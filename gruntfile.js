...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		watch: {
			...
			clientLESS: {
                    files: ['public/lib/bootstarp/less/bootstrap.less'],
                    tasks: ['less']
                },
			mochaTests: {
		...
		less: {
		    development: {
		        ...
		        files: [{
		            src: ['public/lib/bootstrap/less/bootstrap.less', 'public/modules/**/*.less'],
		            dest: 'public/lib/bootstrap/dist/css/bootstrap.css'
		        }]
		    },
		    production: {
		        options: {
		        ...
		        files: [{
		            src: ['lib/bootstrap/less/*.less', 'public/modules/**/*.less'],
		            dest: 'public/lib/bootstrap/dist/css/bootstrap.css'
		        }]
		    }
		},
